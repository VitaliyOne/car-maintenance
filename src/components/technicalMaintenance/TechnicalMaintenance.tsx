...
const TechnicalMaintenance = () => {
  ...
  const [formData, setFormData] = useState<ITechnicalMaintenanceForm>(
    DEFAULT_TECHNICAL_MAINTENANCE_FORM_DATA
  );
  ...
  return (
    <section>
      <time className="time">
        <img src={Maintenance} alt="Maintenance" className="icon" /> &nbsp;{dateTime}
      </time>
      <form>
        <div className="infoOilСhange">
          ...
          <MyInput
            ...
            placeholder="Расходные материалы"
            type="text"
          ></MyInput>
          <MyInput
            onChange={onInputChange}
            name="vendorСode"
            value={formData.vendorСode}
            placeholder="Артикул"
            type="text"
          ></MyInput>
          <InputAdornment
